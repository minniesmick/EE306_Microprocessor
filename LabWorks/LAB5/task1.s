...
STR R2, [R0, #0x4]         // write to the data direction register to set bit 24 (LEDG) of GPIO1 to be an output 
LDR R3,=20000000           // timeout = 1/(200 MHz) x 200x10ˆ6 = 1 sec 
STR R3, [R1]  			   // write to timer load register 
MOV R3, #0b011			   // set bits: mode = 1 (auto), enable = 1 
STR R3, [R1, #0x8]         // write to timer control register 1
...
WAIT: 
	...
	EOR R2, R2, #bit_24_pattern // toggle LEDG value LOOP
	B LOOP 
.end     